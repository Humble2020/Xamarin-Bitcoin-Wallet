    ...
    public class BlockExplorer
    {
        ...
        public async Task<Transaction> GetTransactionByHashAsync(string hash)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                response2 = await httpClient.GetAsync($"{BASE_URI}/{hash}").ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            Transaction responseYY;
             responseYY = JsonConvert.DeserializeObject<Transaction>(stud);
             return responseYY;
        ...
        private async Task<Transaction> GetTransactionAsync(string hashOrIndex)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/rawtx/" + hashOrIndex).ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            Transaction responseYY;
              responseYY = JsonConvert.DeserializeObject<Transaction>(stud);
        ...
        public async Task<Block> GetBlockByHashAsync(string hash)
        {
            ...
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            Block responseYY;
        responseYY = JsonConvert.DeserializeObject<Block>(stud);
            return responseYY;
        }
        ...
        private async Task<Block> GetBlockAsync(string hashOrIndex)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/rawblock/{hashOrIndex}").ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            var bbn = Block.Deserialize(stud);
            return bbn;
        ...
        private async Task<Address> GetAddressAsync(string address, int limit, int offset, FilterType ft)
        {
            ...
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                    response2 = await httpClient.GetAsync($"{BASE_URI}/address/" + address + queryString).ConfigureAwait(false);
                }
                string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
                Address responseYY;
              responseYY = JsonConvert.DeserializeObject<Address>(stud);
                return responseYY;
            ...
            int offset = 0, FilterType filter = FilterType.RemoveUnspendable)
        {
            ...
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                    response2 = await httpClient.GetAsync($"{BASE_URI}/multiaddr" + queryString).ConfigureAwait(false);
                }
                string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
                Xpub Xpub = new Xpub();
                Xpub.Deserialize(stud);
                return Xpub;
            ...
            int offset = 0, FilterType filter = FilterType.RemoveUnspendable)
        {
            ...
            try
            {
                ...
                string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
                MultiAddress responseYY;
                
                        responseYY = JsonConvert.DeserializeObject<MultiAddress>(stud);
                 return responseYY;  
        ...
        public async Task<ReadOnlyCollection<Block>> GetBlocksAtHeightAsync(long height)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/block-height/{height}" + queryString).ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            var bbn = Block.DeserializeMultiple(stud);
            ...
            int limit = DEFAULT_UNSPENT_TRANSACTIONS_PER_REQUEST, int confirmations = 0)
        {
            ...
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                    httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                    response2 = await httpClient.GetAsync($"{BASE_URI}/unspent" + queryString).ConfigureAwait(false);
                }
                string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
                UnspentOutput UnspentOutput = new UnspentOutput();
                var g = UnspentOutput.DeserializeMultiple(stud);


                //return await httpClient.GetAsync("unspent", queryString, UnspentOutput.DeserializeMultiple);l
                return g;
            }
            catch (Exception ex)
            {
        ...
        public async Task<LatestBlock> GetLatestBlockAsync()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/latestblock").ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            LatestBlock responseYY;
              responseYY = JsonConvert.DeserializeObject<LatestBlock>(stud);
             return responseYY;
        ...
        public async Task<ReadOnlyCollection<Transaction>> GetUnconfirmedTransactionsAsync()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/unconfirmed-transactions" + queryString).ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            Transaction Transaction = new Transaction();
            var bbn = Transaction.DeserializeMultiple(stud);
        ...
        public async Task<ReadOnlyCollection<SimpleBlock>> GetBlocksByDateTimeAsync(DateTime dateTime)
        {
            ...
            return await GetBlocksAsync(unixMillis.ToString()).ConfigureAwait(false);
        }
        ...
        public async Task<ReadOnlyCollection<SimpleBlock>> GetBlocksAsync(string poolNameOrTimestamp)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("Accept", "application/json");
                httpClient.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:19.0) Gecko/20100101 Firefox/19.0");
                response2 = await httpClient.GetAsync($"{BASE_URI}/blocks/{queryString}" + poolNameOrTimestamp + queryString).ConfigureAwait(false);
            }
            string stud = await response2.Content.ReadAsStringAsync().ConfigureAwait(false);
            SimpleBlock SimpleBlock= new SimpleBlock();
            var bb = SimpleBlock.DeserializeMultiple(stud);
