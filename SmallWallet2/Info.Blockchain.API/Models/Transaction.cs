...
namespace Info.Blockchain.API.Models
{
    ...
    public class Transaction
    {
        ...
        private object ToFileLock11 { get; }
        private readonly object HdPubKeysLock11;

        public ReadOnlyCollection<Transaction> DeserializeMultiple(string transactionsJson)
        {
            JObject jObject;
         
                    jObject = JObject.Parse(transactionsJson);
